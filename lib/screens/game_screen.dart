...
class TutorialOverlayState extends State<TutorialOverlay> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Inicia cerca del centro superior (donde aparecen las ilustraciones)
    final startX = widget.screenWidth / 2;
    final startY = widget.screenHeight * 0.15; // Un poco más abajo del borde superior

    // Termina en el centro de la zona de destino izquierda (aproximado)
    final endX = widget.screenWidth / 6; // Centro horizontal de la zona izquierda (1/3 de ancho total)
    final endY = widget.screenHeight * 0.6; // Centro vertical de la zona izquierda (un poco más abajo de la mitad)
            ...
            builder: (context, isPaused, _) {
              return ValueListenableBuilder<bool>(
                ...
                builder: (context, levelEnded, _) {
                  ...
                  // Envuelve el contenido principal en otro ValueListenableBuilder para el tutorial
                  return ValueListenableBuilder<bool>(
